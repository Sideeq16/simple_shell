...
/**
 * read_next_char - read user input
 * @current_char: current characer
 * @input_stream: stream
 * Return: int value
 */
...
/**
 * my_getline - get line of text
 * @input_line: line of input
 * @input_line_size: size of input line
 * @input_stream: stream type
 * Return: int value
 */
...
ssize_t my_getline(char **input_line,
	...
	FILE *input_stream)
{
	unsigned long int input_line_pos = 0;
